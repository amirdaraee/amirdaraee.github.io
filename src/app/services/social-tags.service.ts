...
export class SocialTagsService {
  ...
  readonly tagDescription: string =
    'A blog about programming and software development, writing about Spring, Quarkus, java, Angular, DevOps, Docker and kubernetes';
    ...
    this.router.events
      ...
      .subscribe((route: ActivatedRoute) => {
        this.scully.getCurrent().subscribe((link) => {
          this.meta.updateTag({
            name: 'twitter:url',
            content: this.urlPrefix + this.router.url,
          });
          this.meta.updateTag({
            name: 'og:url',
            content: this.urlPrefix + this.router.url,
          ...
          if (link.title) {
            ...
            this.meta.updateTag({
              name: 'image',
              content: this.urlPrefix + '/' + link.photo,
            });
            this.meta.updateTag({
              name: 'og:title',
              property: 'og:title',
            ...
            this.meta.updateTag({
              ...
              content: (link.keywords as string[])[0],
            });
            this.meta.updateTag({
              name: 'og:image',
              content: this.urlPrefix + '/' + link.photo,
            ...
            this.meta.updateTag({
              name: 'twitter:title',
              content: link.title.substring(0, 69),
            });
            this.meta.updateTag({
              name: 'twitter:description',
              content: (link.description as string).substring(0, 123),
            });
            this.meta.updateTag({
              name: 'twitter:image',
              content: this.urlPrefix + '/' + link.photo,
            ...
            this.meta.updateTag({
              name: 'image',
              content: this.urlPrefix + '/' + this.tagImage,
            });
            ...
            this.meta.updateTag({
              name: 'twitter:description',
              content: this.tagDescription.substring(0, 123),
            });
            this.meta.updateTag({
              name: 'twitter:image',
              content: this.urlPrefix + '/' + this.tagImage,
